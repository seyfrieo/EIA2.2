...
(function (Memory) {
    ...
    function init() {
        //Abfrage Kartenpaare
        var paare = prompt("Mit wie vielen Kartenpaaren m�chtest du spielen? (Von 5 bis 8)");
        paareAnz = parseInt(paare);
        if (isNaN(paareAnz) || paareAnz < 5 || paareAnz > 10) {
            ...
            console.log("correct");
            //Abfrage Spieler
            var spieler = prompt("Spieleranzahl (Bis 4 Spieler)");
            var spielerAnz = parseInt(spieler);
